...
class Send_Mail():
	...
	def get_work_content(self):
		...
		self.Content = Send_config.front_code +str(datetime.date.today()) +Send_config.front_code1 + today_work1 +Send_config.front_code2 +today_work2 +Send_config.front_code3 + tomorrow_work +Send_config.front_code4 +Send_config.front_code5
